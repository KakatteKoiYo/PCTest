...
def conexionBaseDatos():
    if fs.exists("perfil.db"):
        ...
        cursor.execute("CREATE TABLE colores(id integer PRIMARY KEY, palabra1 text, palabra2 text, descripcion text)")
        cursor.execute("INSERT INTO nombreslista (nombre, tabla) VALUES('Colores en Inglés (ejemplo)', 'colores')")
        cursor.execute("INSERT INTO colores (palabra1, palabra2, descripcion) VALUES('Azul', 'Blue', 'Color del cielo')")
        cursor.execute("INSERT INTO colores (palabra1, palabra2, descripcion) VALUES('Rojo', 'Red', 'Color de las manzanas')")
        cursor.execute("INSERT INTO colores (palabra1, palabra2, descripcion) VALUES('Verde', 'Green', 'Color de las plantas')")
        cursor.execute("INSERT INTO colores (palabra1, palabra2, descripcion) VALUES('Café', 'Brown', 'Color de la tierra')")
        cursor.execute("INSERT INTO colores (palabra1, palabra2, descripcion) VALUES('Morado', 'Purple', 'Color de las Uvas')")
        cursor.execute("INSERT INTO colores (palabra1, palabra2, descripcion) VALUES('Rosa', 'Pink', 'Color del ajolote')")
        cursor.execute("INSERT INTO colores (palabra1, palabra2, descripcion) VALUES('Negro', 'Black', 'Color de la oscuridad')")
        cursor.execute("INSERT INTO colores (palabra1, palabra2, descripcion) VALUES('Blanco', 'White', 'Color de las nubes')")
        cursor.execute("INSERT INTO colores (palabra1, palabra2, descripcion) VALUES('Amarillo', 'Yellow', 'Color del platano')")
        cursor.execute("INSERT INTO colores (palabra1, palabra2, descripcion) VALUES('Naranja', 'Oranje', 'Color de... la naranja')")
        cursor.execute("INSERT INTO colores (palabra1, palabra2, descripcion) VALUES('Gris', 'Grey', 'Color del humo')")
        con.commit()
        #cursor.execute("SELECT name FROM sqlite_master where type= 'table'")
        cursor.execute("SELECT id, nombre FROM nombreslista")
        rows = cursor.fetchall()
